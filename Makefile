...
FLIST += ${ROOT_DIR}/source/pulp-platform/common_cells/src/fifo_v3.sv
...
FLIST += ${ROOT_DIR}/source/cva6.sv
# FLIST += ${CVA6_REPO_DIR}/core/cva6_rvfi_probes.sv
FLIST += ${ROOT_DIR}/source/cva6_rvfi_probes.sv
...
FLIST += ${ROOT_DIR}/source/instr_queue.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/wt_dcache_mem.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/hpdcache_lfsr.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/hpdcache_rrarb.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/hpdcache.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/hpdcache_victim_sel.sv
# FLIST += ${HPDCACHE_DIR}/rtl/src/hpdcache_wbuf.sv
FLIST += ${ROOT_DIR}/source/cache_subsystem/hpdcache_wbuf.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/cva6_hpdcache_subsystem.sv
...
FLIST += ${ROOT_DIR}/source/cache_subsystem/cva6_hpdcache_wrapper.sv
...
FLIST += ${ROOT_DIR}/source/cva6_mmu.sv
